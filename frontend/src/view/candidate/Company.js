  ...
  return (
    <>
          ...
          <div className="d-flex ps-4 pb-4 pt-1 align-items-start">
            ...
            <div className="ms-3 mt-2">
              <div className="d-flex gap-1 flex-wrap">
                <div className="d-flex align-items-center me-4 rounded-pill px-2 py-1 bg-main-light text-main">
                ...
                <div className="d-flex align-items-center rounded-pill px-2 py-1 bg-main-light text-main">
      ...
      <div className="mx-auto bg-white col-md-9 mt-4 shadow-sm">
        <h5 className="bg-main-light text-main p-3">Giới thiệu công ty</h5>
      ...
      <div className="d-flex justify-content-center mt-4">
        <div className="col-md-9 mb-5">
          <h5 className="bg-main-light text-main col-md-9 p-3 mb-0">
            Việc làm đang tuyển
          </h5>
          {jobs.map((job) => (
            <div
              className="bg-white border-bottom border-main-light col-md-9 ps-3 py-1"
              key={"job" + job.id}
            >
              <div className="d-flex p-3">
                <div className="border border-main-light d-flex align-items-center">
                  <img
                    src={infor.logo}
                    style={{ maxHeight: "130px", maxWidth: "130px" }}
                    alt={infor.name}
